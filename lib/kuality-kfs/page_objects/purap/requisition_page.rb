...
#TODO different type/state selection has different manufacturer/model_number tag name
  element(:manufacturer) { |b| b.frm.text_field(name: /.capitalAssetManufacturerName/, title: 'Manufacturer') }
  element(:model_number) { |b| b.frm.text_field(name: /.capitalAssetModelDescription/, title: 'Model Number') }
