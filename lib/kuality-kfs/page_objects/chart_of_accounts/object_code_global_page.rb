class ObjectCodeGlobalPage < KFSBasePage
  ...
  value(:cg_reporting_code_readonly) { |b| b.frm.span(id: 'document.newMaintainableObject.cgReportingCode.div').text.strip }
  ...
  value(:financial_object_code_description_readonly) { |b| b.frm.span(id: 'document.newMaintainableObject.financialObjectCodeDescr.div').text.strip }
  ...
  value(:active_indicator_readonly) { |b| b.frm.span(id: 'document.newMaintainableObject.financialObjectActiveIndicator.div').text.strip }
  ...
  value(:mandatory_transfer_readonly) { |b| b.frm.span(id: 'document.newMaintainableObject.finObjMandatoryTrnfrOrElimCd.div').text.strip }
  value(:federal_funded_code_readonly) { |b| b.frm.span(id: 'document.newMaintainableObject.financialFederalFundedCode.div').text.strip }
