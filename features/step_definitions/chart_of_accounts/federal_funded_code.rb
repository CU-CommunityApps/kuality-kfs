When /^I create a blank Federal Funded Code$/ do
  @federal_funded_code = create FederalFundedCodeObject, description: nil,
  federal_funded_code: nil, federal_funded_name: nil, press: :submit
end
    ...
    on FederalFundedCodeLookupPage do |page|
      ...
      case activity
        ...
        when 'inactive'
          ...
          warn 'using DEFAULT:: Activity Type'
      end
...
And /^I enter a Federal Funded Code of '(.*)'$/ do |new_ff_code|
  on(FederalFundedCodePage).federal_funded_code.fit new_ff_code
end

And /^I enter a Federal Funded Name of '(.*)'$/ do |new_ff_name|
  on(FederalFundedCodePage).federal_funded_name.fit new_ff_name
end

Then /^I verify the Active Indicator is not checked on the Federal Funding Code$/ do
  on(FederalFundedCodePage).active_indicator.checked?.should be false
end
